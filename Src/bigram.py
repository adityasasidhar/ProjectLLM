...
# Create mappings between characters and their corresponding integer indices
...
def encode(text):
    """
    Convert a string into a list of integer indices based on the character mapping.
...
def decode(indices):
    """
    Convert a list of integer indices back into the original string.
